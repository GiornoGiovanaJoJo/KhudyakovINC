        ...
        <div v-if="showAiInstrModal" class="modal-overlay" @click.self="showAiInstrModal = false">
          <div class="modal-content" style="max-width: 700px">
            ...
            <div class="ai-instr-text">
              <p><strong>Добро пожаловать в Менеджер ИИ!</strong></p>
              <p>Этот инструмент помогает быстро оценивать заявки и отсеивать нерелевантные проекты.</p>
              
              <p><strong>ВКЛАДКА 1: 📊 ОЦЕНКА ЗАКАЗА</strong><br>
              Используйте эту вкладку строго для расчета стоимости проектов.<br>
              👉 <strong>Что писать:</strong> Просто скопируйте и вставьте сырой запрос или ТЗ от клиента как есть.<br>
              👉 <strong>Как ответит ИИ:</strong> Выдаст готовую вилку стоимости с учетом пожеланий клиента и аргументацию цены для продажи.</p>

              <p><strong>ВКЛАДКА 2: 💬 ВОПРОСЫ ИИ</strong><br>
              Используйте эту вкладку для проверки — подходящий ли заказ принес клиент, или вопросы по стеку.<br>
              👉 <strong>Что писать:</strong> Задавайте прямые вопросы. Например: <em>"Какие заказы мне искать?"</em>, <em>"Берем ли мы магазины на WordPress?"</em>, <em>"Можно ли взять доработку на GoLang?"</em><br>
              👉 <strong>Как ответит ИИ:</strong> Подскажет, стоит ли браться за заказ, исходя из возможностей команды и наших стоп-факторов (мы не берем WP/GoLang, фокус на Python и кастом).</p>
            </div>
          </div>
        </div>
      </Teleport>
